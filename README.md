...
**strncpy**	
###
Копирует строку с ограничением количества символов
...
**strncat**	
###
Конкатенирует строки с ограничением символов

**strchr**	
###
Находит первое вхождение символа char 

**strrchr**	
###
Находит последнее вхождение символа	char 
...
**strspn**	
###
Подсчитывает длину участка, содержащего только символы из заданного набора

**strcspn**	
###
Подсчитывает длину участка до любого символа из заданного набора

**strtok**	
###
Разделяет строку на токены, используя разделители
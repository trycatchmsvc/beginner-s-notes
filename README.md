...
h1 First step -> "Hello world" without namespace
```c++
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
												...
												#Second step -> 'Hello world' with namespace
...
//Если строка содержит символы, которые printf интерпретирует как форматные спецификаторы, это может привести к ошибкам //выполнения или некорректному выводу.

printf("%s\n", text_string.c_str());

//Этот способ гарантирует, что printf правильно интерпретирует строку как текст для вывода, а не как форматную строку. Это //лучший подход для безопасного и предсказуемого вывода строк в C++.

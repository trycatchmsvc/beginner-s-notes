//21. Написать функцию int splice_array(int arr1[], int arr2[], int len, int arr_out[]), которая соединяет массивы
...
int main() {
    ...
    int result_size = splice_array(arr_1, arr_2, len, arr_out);

 ...
 */
class TOYNOTELIB_EXPORT Notebook : public QAbstractTableModel
{
    Q_OBJECT
public:
    /*!
    ...
    //! Устанавливает заметку с индексом \a idx в записной книжке.
    void setNote(SizeType idx, Note note);
private:
